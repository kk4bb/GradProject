    ...
    public class AssignmentServiceTests
    {
        ...
        public async Task GradeSubmissionAsync_UpdatesGrade()
        {
            ...
            await service.GradeSubmissionAsync(
                1,
                new SubmissionGradeDto { Grade = 95.5, Feedback = "Strong analysis." },
                instructorId);

            // Assert
            var updated = context.Submissions.First();
            Assert.Equal(95.5, updated.Grade);
            Assert.Equal("Strong analysis.", updated.Feedback);
        }
    }
}
